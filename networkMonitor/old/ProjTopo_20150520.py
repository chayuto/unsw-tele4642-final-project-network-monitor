...
def perfTest():
    ...
    for i in range(0,4):
        net.iperf([h1,h2],port = 1433,seconds = 7)
        net.iperf([h2,ser3],port = 80,seconds = 1)
        net.iperf([h3,ser1],port = 443,seconds = 7)
        net.iperf([h4,ser2],port = 80,seconds = 5)
    net.iperf([h3,ser1],port = 443,seconds = 7)
    net.iperf([h3,ser1],port = 443,seconds = 5)
    net.iperf([h3,ser1],port = 443,seconds = 7)
    for i in range(0,3):   
        net.iperf([h2,ser3],port = 80,seconds = 7)
        net.iperf([h3,ser1],port = 443,seconds = 7)
        net.iperf([h1,ser3],port = 80,seconds = 7)
        net.iperf([h4,ser3],port = 80,seconds = 7)
    for i in range(0,4):
        net.iperf([h3,h2],port = 1433,seconds = 4)
        net.iperf([h1,ser3],port = 80,seconds = 4)
        net.iperf([h4,ser3],port = 80,seconds = 4)
    for i in range(0,2):
        net.iperf([h3,h2],port = 1433,seconds = 2)
